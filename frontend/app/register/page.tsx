...
import JoinGroupModal from "../../components/JoinGroupModal"; // Import JoinGroupModal
...
const RegisterPage = () => {
  ...
  function handleJoinGroup(groupCode: string): void {
          ...
          <div className="relative flex flex-col items-center w-full">
            {[
              ...
              <div key={index} className="flex items-center w-full relative mb-8">
                {index < 3 && (
                  <div
                    className={`absolute top-full left-[1.7rem] h-12 w-0.5 ${step > index + 1 ? "bg-black" : "bg-gray-300"} z-0`}
                  ></div>
                )}
                ...
                <span
                  className={`ml-10 text-lg ${step > index ? "font-semibold text-black" : "text-gray-500"}`}
                >
                  {stepInfo.label}
                </span>
              </div>
          ...
          {step === 3 && (
            <>
              ...
              <div className="flex flex-col space-y-4">
                <Button onClick={() => setIsJoinModalOpen(true)} className="w-full bg-black text-white">
                  Join Group
                </Button>
              </div>
              ...
              <JoinGroupModal
                ...
                onJoin={(groupCode) => handleJoinGroup(groupCode)}
              />
